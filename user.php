...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE user SET u_fullname='$u_fullname', u_username='$u_username',u_address='$u_address', u_phone='$u_phone' WHERE u_id='$u_id'";
    if (mysqli_query($objCon, $sql)) {
        echo '<script>alert("แก้ไขข้อมูลสำเร็จ"); window.location.href="editformuser.php";</script>';
    } else {
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="editformuser.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="form-group mb-2">
                                                <label for="u_fullname_<?php echo $row["u_id"]; ?>" class="form-label">ชื่อสมาชิก:</label>
